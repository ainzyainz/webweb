...
public class BalanceServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (action) {
            case ACTION_ADDFIVE:
                transactionHandler.toBalance(userDTO, 5);
                break;
            case ACTION_ADDTEN:
                transactionHandler.toBalance(userDTO, 10);
                break;
            case ACTION_ADDTWENTY:
                transactionHandler.toBalance(userDTO, 20);
                break;
            case ACTION_ADDFIFTY:
                transactionHandler.toBalance(userDTO, 50);
                break;
            case ACTION_ADDGRAND:
                transactionHandler.toBalance(userDTO, 100);
                break;
            default:
